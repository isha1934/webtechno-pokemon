...
```
cd existing_repo
git remote add origin https://gitlab.bht-berlin.de/isha1934/webtechno.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.bht-berlin.de/isha1934/webtechno/-/settings/integrations)
...
## 🐳 Docker Support (Abdelrahman)

### How to run

Run the app easily with one command:
